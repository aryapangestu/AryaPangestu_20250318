...
namespace AryaPangestu_20250318.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderPostCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ...
                    RecipientPostCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ...
                    CurrentStatus = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Created")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentStatusHistory", x => x.StatusId);
                    table.ForeignKey(
                        name: "FK_ShipmentStatusHistory_Shipment",
            ...
            migrationBuilder.CreateIndex(
                name: "UK_Shipment_TrackingNumber",
                table: "Shipment",
